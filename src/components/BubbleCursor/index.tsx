...
class Particle {
  ...
  constructor(x: number, y: number) {
    ...
    this.position = { x, y };
    this.baseDimension = Math.random() * 6 + 8;
  }
  ...
  update(context: CanvasRenderingContext2D) {
    ...
    gradient.addColorStop(0.4, "rgba(170, 220, 240, 0.7)");
    gradient.addColorStop(0.7, "rgba(80, 170, 220, 0.5)");
    gradient.addColorStop(1, "rgba(80, 170, 220, 0.25)");

    context.fillStyle = gradient;
    context.strokeStyle = "rgba(180, 230, 255, 0.6)";
